...
Xunit_test: # integration testing for code
  ...
  services: # it inherited all the variables above
    - name: postgres:14.22-alpine # additional db service (here can also take your own gitlab registry image it will speed up pipeline lil bit)
...
build-sonar-mr: # this job was mostly generated by sonarqube
...
build-sonar-main: # this job was mostly generated by sonarqube aswell
...
preview:
    ...
    before_script:
      - !reference [.default_before_script,script] # setting up ssh for login
    script:
      ...
      - |
        ...
        services:
          proxydb:
            ...
            labels:
              - "traefik.enable=true"
              - "traefik.http.routers.${CI_COMMIT_REF_SLUG}.rule=Host(\`${CI_COMMIT_REF_SLUG}.{my host was here hided it aswell}\`)"
      ...
      - |
          echo "Preview URL: https://$CI_COMMIT_REF_SLUG.{my host was here hided it aswell}/Home/Hello"
    ...
    environment:
      ...
      url: "http://$CI_COMMIT_REF_SLUG.{my host was here hided it aswell}/Home/Hello"
